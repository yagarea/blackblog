...
- **Kovalentní vazba**
	...
	- v přírodě je velmi rozšířená - atomy nekovových prvků se váží samy se sebou v molekuly (H$$_2$$ , Cl$$_2$$ , O$$_2$$, CH$$_4$$, H$$_2$$O, HNO$$_3$$)
...
- $$F_p$$ - síla pružnosti
- $$S$$  - plocha řezu kolmého k vektoru síly $$\vec F_p$$
...
- $$AB$$ - oblast dopružování
- $$\sigma_E$$ - mez pružnosti - největší hodnota normálového napětí, kdy je deformace ještě pružná. Po překročení je těleso trvale deformováno.
- $$CD$$ - tečení materiálů (tažení drátu)
- $$\sigma_k$$ - mez kluzu
- $$DE$$ - zpevnění materiálu
- $$\sigma_p$$ - mez pevnosti - po překročení této hodnoty normálového napětí dojde k porušení materiálu - přetrhne se, rozdrtí se
- dovolené napětí - nejvyšší přípustná hodnota $$\sigma_n$$ při deformaci tahem nebo tlakem. Jeho hodnota je značně menší než mez pevnosti. Podíl meze pevnosti a dovoleného napětí je **koeficient bezpečnosti**
...
- $$E$$ - modul pružnosti v tahu [Pa] (v MFChT)
...
- $$\alpha$$ - teplotní součinitel délkové roztažnosti [K$$^{-1}$$] (v MFChT)
- $$t$$ - teplota tělesa
...
- $$\beta$$ - teplotní součinitel roztažnosti [K$$^{-1}$$], $$\beta \approx 3\alpha$$
...
- měrné skupenské teplo tání $$l_t$$

$$ l_t = \frac{L_t}{m} $$

- $$L_t$$ - skupenské teplo tání [J.kg$$^{-1}$$]
