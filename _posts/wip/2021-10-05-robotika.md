...
- Senzory se pohybují robotem - má lokální souřadnice
...
- Chceme modelovat $$Bel(x) = P(x|l_{1},\dots,l_{k})$$ 
...
- **Odhad ušlé vzdálenosti**
    ...
    - Worst case
    - Za každou překážku v okruhu $|target-start|$ od cíle započítáme 1.5 násobek obvodu(obejde ji a zvolí kratší cestu k minimu) + $|target-start|$
