...
| Substraction $$a$$ from $$b$$ we obtain<br/>Substraction $$a$$ from $$b$$ we get<br/>Substraction $$a$$ from $$b$$ we have| Odečtením $$a$$ od $$b$$ získáváme |
...
| A trivial verification shows that...<br/>A trivial verification makes it obvious that... | Jednuduché ověření ukáže, že... |
...
| The theorem states that ...<br/>The theorem asserts that ... | Věta řiká, že ... |
...
| It is immaterial which $$k$$ we choose		| Lze zvolit libolé $$k$$ |
