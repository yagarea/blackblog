...
| Adding $$a$$ to the right-hand side yields<br/>Adding $$a$$ to the right-hand side gives | Přičtením $$a$$ k pravé straně dostáváme |
| Subtraction $$a$$ from $$b$$ we obtain<br/>Subtraction $$a$$ from $$b$$ we get<br/>Subtraction $$a$$ from $$b$$ we have| Odečtením $$a$$ od $$b$$ získáváme |
| It suffices to show that...<br/>It is sufficient to show that | Postačí dokázat, že... |
...
| It is clear that...<br/>It is evident that... | Je zřejmé, že... |
| It is easily seen that..                      | Lze snad vidět, že... |
| A trivial verification shows that...<br/>A trivial verification makes it obvious that... | Jednoduché ověření ukáže, že... |
| ..., which completes the proof<br/>..., which proves the theorem | ..., a tím je důkaz proveden |
...
| The theorem states that ...<br/>The theorem asserts that ... | Věta říká, že ... |
...
| ... which gives $$a=b$$<br/>... which yields $$a=b$$ | ... což nám dává $$a=b$$ |
...
| Here $$A$$, denotes the matrix ...<br/>Here $$A$$ stands for matrix ... | $$A$$, zde označuje matici ...          |
...
| Hence                                             | Proto<br/>z tohoto důvodu<br/>tudíž                       |
...
| $$\equiv$$            | is identical with<br/>is always equal to  | je identické<br/>je ekvivalentní |
...
| $$x''$$               | $$x$$ double-prime<br/>$$x$$ double-dashed | $$x$$ s dvěma čárkami |
| $$x^*$$               | $$x$$ star<br/>$$x$$ asterisk             | $$x$$ s hvězdičkou |
| $$\bar{a}$$           | $$a$$ bar                                 | |
| $$\tilde{a}$$         | $$a$$ tide                                | |
...
| $$()$$                | parenthesis<br/>brackets                  | kulaté závorky |
| $$[]$$                | square brackets                           | hranaté závorky |
| $$\{\}$$              | braces                                    | složené závorky<br/>"chlupatý závorky" |
